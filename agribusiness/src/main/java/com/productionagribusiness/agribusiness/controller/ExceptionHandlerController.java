...
import com.productionagribusiness.agribusiness.exception.ExceptionResponse;
...
public class ExceptionHandlerController extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        ExceptionResponse exceptionResponse = new ExceptionResponse(new Date(), "Validation Failed", ex.getBindingResult().getFieldErrors().get(0).getDefaultMessage());
