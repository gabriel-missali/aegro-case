...
import com.productionagribusiness.agribusiness.jwt.JwtTokenUtil;
...
public class JwtAuthenticationRestController {
    ...
    public ResponseEntity<?> createAuthenticationToken(@RequestBody JwtTokenRequest authenticationRequest)
        ...
        final String token = jwtTokenUtil.generateToken(userDetails, jwtUserDetails.getId(), jwtUserDetails.getName());
